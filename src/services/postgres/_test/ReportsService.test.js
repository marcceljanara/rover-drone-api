...
describe('ReportsService', () => {
  ...
  beforeAll(async () => {
    ...
    const paymentId1 = (await rentalsService.addRental(addRentalPayload(user1), 'user')).payment_id;
    const paymentId2 = (await rentalsService.addRental(addRentalPayload(user2), 'user')).payment_id;
    const payload1 = {
      id: paymentId1,
